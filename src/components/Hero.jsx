...
import image from '../assests/lakshya-profile.jpg'
...
const Hero = () => {
  ...
  return (
    <section className="pt-20 md:pt-24 pb-12 lg:pt-32 lg:pb-16 bg-hero-gradient dark:bg-hero-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            {/* Badge */}
            <motion.div 
              className="inline-flex items-center space-x-2 bg-slate-100 dark:bg-slate-800/50 text-slate-700 dark:text-slate-300 px-3 py-2 md:px-4 md:py-2 rounded-full text-xs md:text-sm font-medium border border-slate-200 dark:border-slate-700"
            ...
            > 
            <motion.a
              href="https://www.linkedin.com/in/lakshya-jangid-0562502a2/"
              target="_blank"
            ...
            >
              ...
              Visit LinkedIn
                ...
                <motion.a 
                    ...
                    className="inline-flex items-center justify-center px-6 py-3 md:px-8 md:py-4 border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 font-semibold rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-all duration-300 text-sm md:text-base"
                  >
          ...
          >
            <div className="relative w-64 sm:w-80 md:w-96 lg:w-full lg:max-w-lg">
              ...
              >
                ...
                {/* Floating elements
                <motion.div 
                  className="absolute top-4 right-4 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm p-2 rounded-lg shadow-lg"
                  animate={{ y: [0, -10, 0] }}
                ...
                <motion.div 
                  className="absolute bottom-4 left-4 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm p-2 rounded-lg shadow-lg"
                  animate={{ y: [0, -8, 0] }}
